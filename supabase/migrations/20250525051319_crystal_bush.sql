/*
  ...
  1. New Tables
    - `profiles`
      ...
      - Includes user type (employer/caregiver)
    
    - `caregivers`
      - Stores caregiver profiles and details
      - Links to profiles table
      - Includes all caregiver-specific information
    
    - `reviews`
      - Stores reviews for caregivers
      - Links to both caregivers and profiles tables
    
    - `messages`
      - Stores messages between users
      - Links to profiles table for sender and recipient
